...
public class LoginTestScript {
	...
	public static void main(String[] args) throws InterruptedException, IOException {
		...
		addDetailsToLoginForm(driver, "Murali", "Murali@gmail.com", "Murali@123");// get login data
		addDetailToRegisterForm(driver, "Murali@gmail.com", "Murali", "Murali@123");// get register data
